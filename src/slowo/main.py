...
from .wepwace import char_replace, word_replace


class UwU:
    @staticmethod
    def ify(
        input_string: str, *, stutter_strength: float = 0.2, emoji_strength: float = 0.2
    ) -> str:
        ...
        input_string = stutter(
            stutter_strength, input_string
        )  # after lots of toil, stuttering is d-done...
